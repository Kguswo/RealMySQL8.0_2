...
# Deep Dive  
Deep Dive into Real My SQL 8.0(2)

--- 
</div>

## Contents
#### 1주차(2025.12.02 ~ 2025.12.08)
- **범위** 
...
#### 3주차(2025.12.13 ~ 2025.12.14)
- **범위** 104p ~ 147p (잠금을 사용하는 SELECT)
- **세미나**
    - 장우: [MySQL 서브쿼리(Subquery)](https://github.com/BackEndDeepDive/RealMySQL8.0_2/tree/main/choijangwoo/week_3)
